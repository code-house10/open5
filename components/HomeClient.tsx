...
export default function HomeClient({ data }: { data: LandingData }) {
    useEffect(() => {
    ...
    return (
        <>
                    ...
                    <div className="container">
                        <div className="row g-4">
                            ...
                            <div className="col-xl-6 col-lg-8 mx-auto mx-xl-0">
                                <div className="faq-img position-relative align-self-end">
                                    <div className="img effect-1 reveal zoom-out">
                                        <img src="/assets/img/faq/faq-img.png" className="w-100" alt="الأسئلة الشائعة" />
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            {/* Footer */}
            <footer className="footer-section position-relative overflow-hidden bg-dark text-white pt-120">
                <div className="container">
                            ...
                            <div className="footer-widget">
                                <div className="logo mb-4">
                                    <a href="#" className="d-flex align-items-center gap-2 text-decoration-none">
                                        <img src="/assets/img/logo/logo-white.svg" alt="Transit Logistics" style={{ height: '50px' }} />
                                        <div className="text-white">
                                            <h4 className="m-0 fw-bold">ترانزيت</h4>
                                            <small className="d-block" style={{ color: '#f39c12' }}>لوجستيكس</small>
                                        </div>
                                    </a>
                                </div>
                                <p className="mb-4 text-white-50">نحن نقدم أفضل خدمات نقل العفش والأثاث في مصر، مع الالتزام بالمواعيد والحفاظ على ممتلكاتك.</p>
                                <div className="social-links d-flex gap-3">
                                    {contactInfo.facebook_url && <a href={contactInfo.facebook_url} className="rounded-circle d-flex align-items-center justify-content-center text-white bg-white bg-opacity-10"><i className="fab fa-facebook-f"></i></a>}
                                    <a href={`https://wa.me/2${contactInfo.whatsapp}`} className="rounded-circle d-flex align-items-center justify-content-center text-white bg-white bg-opacity-10"><i className="fab fa-whatsapp"></i></a>
                                    {contactInfo.instagram_url && <a href={contactInfo.instagram_url} className="rounded-circle d-flex align-items-center justify-content-center text-white bg-white bg-opacity-10"><i className="fab fa-instagram"></i></a>}
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-2 col-md-6">
                            <div className="footer-widget">
                                <h4 className="widget-title mb-4">روابط سريعة</h4>
                                <ul className="list-unstyled footer-links">
                                    <li><a href="#" className="text-white-50 text-decoration-none transition-300">الرئيسية</a></li>
                                    <li><a href="#about" className="text-white-50 text-decoration-none transition-300">من نحن</a></li>
                                    <li><a href="#services" className="text-white-50 text-decoration-none transition-300">خدماتنا</a></li>
                                    <li><a href="#portfolio" className="text-white-50 text-decoration-none transition-300">أعمالنا</a></li>
                                    <li><a href="#contact" className="text-white-50 text-decoration-none transition-300">اتصل بنا</a></li>
                                </ul>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-6">
                            <div className="footer-widget">
                                <h4 className="widget-title mb-4">تواصل معنا</h4>
                                <ul className="list-unstyled footer-contact">
                                    <li className="d-flex gap-3 mb-3">
                                        <i className="fas fa-phone mt-1" style={{ color: '#f39c12' }}></i>
                                        <a href={`tel:+2${contactInfo.phone}`} className="text-white-50 text-decoration-none">{contactInfo.phone}</a>
                                    </li>
                                    <li className="d-flex gap-3 mb-3">
                                        <i className="fas fa-envelope mt-1" style={{ color: '#f39c12' }}></i>
                                        <a href={`mailto:${contactInfo.email}`} className="text-white-50 text-decoration-none">{contactInfo.email}</a>
                                    </li>
                                    <li className="d-flex gap-3 mb-3">
                                        <i className="fas fa-map-marker-alt mt-1" style={{ color: '#f39c12' }}></i>
                                        <span className="text-white-50">{contactInfo.address}</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div className="footer-bottom text-center py-4 mt-5 border-top border-white border-opacity-10">
                        <p className="m-0 text-white-50">جميع الحقوق محفوظة &copy; {new Date().getFullYear()} ترانزيت لوجستيكس</p>
                    </div>
                </div>
            </footer>
        </>
